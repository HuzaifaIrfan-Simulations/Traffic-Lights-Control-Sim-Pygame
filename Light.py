...
class Light:
    ...
    def draw(self,win):
        ...
        text=STAT_FONT.render("rg = "+str(self.runninggreencount)+", ry = "+str(self.runninglightchangecount),1,(100,100,100))

        win.blit(text,(self.x-20,self.y+size+10))

        text=STAT_FONT.render("sg = "+str(self.greencount)+", sy = "+str(self.lightchangecount),1,(100,100,100))

        win.blit(text,(self.x-20,self.y+size+30))

        text=STAT_FONT.render("Cars = "+str(self.cars),1,(100,100,100))

        win.blit(text,(self.x-20,self.y+size+50))


        text=STAT_FONT.render("Waiting = "+str(self.waitingtime),1,(100,100,100))

        win.blit(text,(self.x-20,self.y+size+70))

        text=STAT_FONT.render("Total running time = "+str(self.totalrunningtime),1,(100,100,100))
    ...
    def running(self):
        ...
        if self.greencount==0:
            ...
            if self.runninglightchangecount < 0:
                ...
                self.totalrunningtime+= (2*(self.lightchangecount) + self.greencount) 
